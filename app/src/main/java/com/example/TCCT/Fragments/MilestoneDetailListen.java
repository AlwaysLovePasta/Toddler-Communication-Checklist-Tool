...
public class MilestoneDetailListen extends Fragment {

    private static final String INDEX = "index";
    private static Integer position;
    private final int[] totalScoreList = {25, 25, 20, 20, 20, 20, 20, 20, 30};
    ...
    public MilestoneDetailListen() {
        // Required empty public constructor
    }

    public static MilestoneDetailListen newInstance(Integer position) {
        MilestoneDetailListen fragment = new MilestoneDetailListen();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_milestone_detail_listen, container, false);
    }
    ...
    private void setScore(Integer milestoneIndex) {
        firebaseData.readMilestoneScore(requireContext(), milestoneIndex, scoreSet -> {
            score.setText(String.valueOf(scoreSet.get(0)));
            String percentage = String.format("%.0f", (((Number) scoreSet.get(0)).floatValue() / totalScoreList[milestoneIndex]) * 100);
